...
namespace LocationShots.BLL
{
    ...
    public static class Selenium
    {
        ...
        internal static string SkipCoverPage(string url)
        {
            ...
            IWebElement test;
            test = Waiter.Until(ExpectedConditions.ElementToBeClickable(By.Id(cbo1Id)));
            Thread.Sleep(5000);
            ClickField(By.Id(cbo1Id));
            test = Waiter.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(cbo1ListCss)));
            test = Waiter.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(cbo1ElementCss)));
            ClickField(By.CssSelector(cbo1ElementCss));
            Thread.Sleep(5000);

            test = Waiter.Until(ExpectedConditions.ElementToBeClickable(By.Id(cbo2Id)));
            Thread.Sleep(5000);
            ClickField(By.Id(cbo2Id));
            test = Waiter.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(cbo2ElementCss)));
        ...
        public static bool LoginToCml(string user, string pass, string url)
        {
            try
            {
                ...
                //CurrentDriver.Navigate().GoToUrl(url);
                //IWebElement userField = Waiter.Until(ExpectedConditions.ElementIsVisible(By.XPath("//input[contains(@id,'txtCnpj')]")));
                //IWebElement userField = Waiter.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector("input#txtCnpj")));
                //IWebElement userField = Waiter.Until(ExpectedConditions.ElementToBeClickable(By.Id("txtCnpj")));
        ...
        public static void EnterTicker(string tickerName)
        {
            ...
            IWebElement field = Waiter.Until(ExpectedConditions.ElementIsVisible(By.Id("ticker_input")));
            field.SendKeys(tickerName);
        }
        public static void SelectStrategy(string strategy)
        {
            //IWebElement field = Waiter.Until(ExpectedConditions.ElementIsVisible(By.Id(Lookups.StrategyElementIDs[strategy])));
            IWebElement field = Waiter.Until(ExpectedConditions.ElementToBeClickable(By.Id(Lookups.StrategyElementIDs[strategy])));
            field.Click();
        }
        public static void SelectLongOrShort(string longOrShort)
        {
            IWebElement field = Waiter.Until(ExpectedConditions.ElementToBeClickable(By.Id(Lookups.LongOrShortElementIDs[longOrShort])));
            field.Click();
        }
        public static void SelectEarningsHandling(string earningsHandling)
        {
            IWebElement field = Waiter.Until(ExpectedConditions.ElementToBeClickable(By.Id(Lookups.EarningsHandlingsIDs[earningsHandling])));
            field.Click();
        }
        public static bool ConfirmChartsLoaded()
        {
            try
            {
                ...
                //IWebElement field = Waiter.Until(ExpectedConditions.ElementIsVisible(By.CssSelector(".highcharts-credits")));
                ...
                IWebElement field = Waiter.Until(ExpectedConditions.ElementIsVisible(By.Id("result_4")));
                ...
                //not working
                IWebElement field = Waiter.Until(ExpectedConditions.ElementIsVisible(By.CssSelector(".highcharts-legend")));
                IWebElement field = Waiter.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector(".highcharts-navigator")));
        ...
        public static bool ConfirmValidConfiguration()
        {
            try
            {
                IWebElement field = Waiter.Until(ExpectedConditions.ElementIsVisible(By.Id("top_message")));
        ...
        public static void PressEnterOnField(By id)
        {
            try
            {
                var field = Waiter.Until(ExpectedConditions.ElementToBeClickable(id));
        ...
        public static void SetComboByText(By id, string value)
        {
            try
            {
                IWebElement ExecutionFillTypeField = Waiter.Until(ExpectedConditions.ElementIsVisible(id));
    ...
    public static class extensions
    {
        ...
        {
            //IWebElement username = WebDriverWait.Until(ExpectedConditions.ElementIsVisible(By.Id("usernameId")));
